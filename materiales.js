...
MRsat = 1019,05649*EXP(0,36935*SOPsat);
MRhum = 1019,05649*EXP(0,36935*SOPhum);
MRsec = 1019,05649*EXP(0,36935*SOPhum);

MR = 2184,56125*EXP(0,03466*VRC);
MR = 2608,8492*EXP(0,0329*VRW);
MR = 1923,6422*POTENCIA(CBRK;0,68839);
MR =13,50112*IG*IG- 650,87922*IG + 10255,5755;
